...
public class POIServiceTest {
        ...
        void testInsertPOI_ShouldReturnPOIDTO() {
                ...
                assertAll(
                                ...
                                () -> assertEquals(POI_DTO.getDescription(), result.getDescription(),
                                                "POI description must match"),
                                ...
                                () -> assertEquals(POI_DTO.getMotivations(), result.getMotivations(),
                                                "POI motivations must match"),
                                () -> assertEquals(POI_DTO.getAddress(), result.getAddress(),
                                                "POI address must match"));
        }

        @Test
        void testFindAllPOIs_ShouldReturnPage() {
                // given / arrange
                POI poi = new POI("Parque da Cidade", "Um grande parque urbano com áreas verdes, trilhas e lagos.",
                                MOTIVATIONS, HOBBIES, THEMES, ADDRESS);
        ...
        void testUpdatePOI_ShouldUpdatePOI() {
                ...
                // then / assert
                verify(poiRepository, times(1)).save(poi);
        }
